...
function makeStyles(colors: AuthColors, rtl: boolean) {
  ...
  const base = withAppFont(StyleSheet.create({
    ...
    brand: { color: colors.primary, fontSize: rtl ? 31 : 28, fontWeight: '800', textAlign: align, writingDirection: writing },
    headline: { marginTop: 6, color: colors.ink, fontSize: rtl ? 43 : 44, lineHeight: rtl ? 50 : 48, fontWeight: '800', textAlign: align, writingDirection: writing },
    subtitle: { marginTop: 14, color: colors.body, fontSize: rtl ? 25 : 23, fontWeight: '600', lineHeight: rtl ? 32 : 30, textAlign: align, writingDirection: writing },
    ...
    primaryText: { color: '#FFFFFF', fontSize: 22, fontWeight: '700' },
    inlineLink: { minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' },
    linkMuted: { color: colors.muted, fontSize: 17, fontWeight: '600' },
    linkStrong: { color: colors.primary, fontSize: 17, fontWeight: '800' },
    authSpacer: { height: 110 },
    authHeadline: { color: colors.ink, fontSize: rtl ? 46 : 50, lineHeight: rtl ? 54 : 56, fontWeight: '800', textAlign: 'center', writingDirection: writing },
    ...
    choiceText: { color: colors.muted, fontSize: 24, fontWeight: '600' },
    ...
    authNote: { marginTop: 26, color: colors.muted, fontSize: 18, fontWeight: '600', lineHeight: 25, textAlign: 'center', writingDirection: writing },
    ...
    input: { flex: 1, minHeight: 52, color: colors.ink, fontSize: 21, fontWeight: '600' },
