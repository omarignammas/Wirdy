...
function makeStyles(colors: AuthColors, rtl: boolean) {
  ...
  const base = withAppFont(StyleSheet.create({
    ...
    utilityButton: { minWidth: 50, height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 18, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.card },
    ...
    logoPlate: { width: 136, height: 136, alignItems: 'center', justifyContent: 'center', borderRadius: 36, backgroundColor: colors.primary, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 24, shadowOffset: { width: 0, height: 14 } },
    logo: { width: 112, height: 112, borderRadius: 28 },
    featureCard: { position: 'absolute', minHeight: 44, flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 13, borderRadius: 16, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.pill, shadowColor: colors.shadow, shadowOpacity: 1, shadowRadius: 15, shadowOffset: { width: 0, height: 8 } },
    ...
    primary: { minHeight: 62, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderRadius: 32, backgroundColor: colors.primary },
    ...
    choiceButton: { minHeight: 62, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 18, borderRadius: 32, borderWidth: 1.5, borderColor: colors.line, backgroundColor: colors.card },
    ...
    field: { minHeight: 62, flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 18, borderWidth: 1.5, borderColor: colors.line, borderRadius: 22, backgroundColor: colors.card },
    input: { flex: 1, minHeight: 52, color: colors.ink, fontSize: 21, fontWeight: '500' },
    errorBox: { minHeight: 50, flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 14, borderRadius: 16, backgroundColor: `${colors.danger}14` },
