...
function makeStyles(p: Palette, rtl: boolean) {
  ...
  return withAppFont(StyleSheet.create({
    ...
    header: { position: 'relative', flexDirection: row, alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.lg, paddingTop: Platform.OS === 'android' ? 15 : spacing.md, paddingBottom: spacing.md }, headerHairline: { position: 'absolute', left: 0, right: 0, bottom: 0, height: StyleSheet.hairlineWidth, backgroundColor: p.line }, largeTitle: { color: p.ink, fontSize: 36, lineHeight: 42, fontWeight: '800', marginBottom: spacing.md, textAlign: align, writingDirection: writing },
    ...
    headerCopy: { flex: 1, minWidth: 0, justifyContent: 'center' }, headerKicker: { color: p.muted, fontSize: 11, fontWeight: '600', textAlign: align, writingDirection: writing }, headerTitle: { color: p.ink, fontSize: 22, fontWeight: '800', lineHeight: 30, textAlign: align, writingDirection: writing },
    headerButton: { position: 'relative', width: 48, height: 48, borderRadius: 22, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, alignItems: 'center', justifyContent: 'center', ...softRaised }, pressablePressed: { opacity: 0.72, transform: [{ scale: 0.97 }] }, pressableDisabled: { opacity: 0.48 }, notificationDot: { position: 'absolute', top: 8, right: 8, width: 8, height: 8, borderRadius: 4, borderWidth: 2, borderColor: p.surface, backgroundColor: p.gold },
    notificationToast: { position: 'absolute', zIndex: 20, top: 104, left: spacing.lg, right: spacing.lg, minHeight: 58, flexDirection: row, alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, shadowColor: p.shadow, shadowOpacity: 1, shadowRadius: 20, shadowOffset: { width: 0, height: 10 }, elevation: 3 }, notificationToastText: { flex: 1, color: p.ink, fontSize: 14, lineHeight: 19, fontWeight: '600', textAlign: align, writingDirection: writing },
    nextStrip: { minHeight: 82, flexDirection: row, alignItems: 'center', justifyContent: 'space-between', padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.primaryMuted }, smallMuted: { color: p.muted, fontSize: 12, fontWeight: '500', textAlign: align, writingDirection: writing }, nextStripTitle: { marginTop: 2, color: p.primary, fontSize: 19, fontWeight: '800', textAlign: align }, timeChip: { minHeight: 46, flexDirection: row, alignItems: 'center', gap: spacing.xs, paddingHorizontal: spacing.md, borderRadius: radius.lg, backgroundColor: p.surface }, timeChipText: { color: p.primary, fontSize: 15, fontWeight: '800', fontVariant: ['tabular-nums'] },
    heroCard: { marginTop: spacing.md, padding: spacing.lg, borderRadius: radius.xxl, backgroundColor: p.primaryDeep, shadowColor: p.shadow, shadowOpacity: 1, shadowRadius: 24, shadowOffset: { width: 0, height: 12 }, elevation: 3 }, heroTop: { flexDirection: row, alignItems: 'flex-start', justifyContent: 'space-between', gap: spacing.sm }, heroKicker: { color: 'rgba(255,255,255,0.72)', fontSize: 12, fontWeight: '600', textAlign: align }, heroTitle: { maxWidth: 250, marginTop: 2, color: '#FFFFFF', fontSize: 27, fontWeight: '800', lineHeight: 34, textAlign: align, writingDirection: writing }, partChip: { paddingHorizontal: spacing.sm, paddingVertical: spacing.sm, borderRadius: radius.md, backgroundColor: 'rgba(255,255,255,0.11)' }, partChipText: { color: '#FFFFFF', fontSize: 11, fontWeight: '700' },
    ...
    goalRow: { flexDirection: row, alignItems: 'center', justifyContent: 'space-between', marginTop: spacing.md, padding: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, goalCopy: { flex: 1 }, goalTitle: { color: p.ink, fontSize: 22, fontWeight: '800', lineHeight: 28, textAlign: align, writingDirection: writing }, cardTitle: { color: p.ink, fontSize: 16, fontWeight: '700', lineHeight: 23, textAlign: align, writingDirection: writing }, cardMeta: { marginTop: 3, color: p.muted, fontSize: 12, fontWeight: '500', lineHeight: 19, textAlign: align, writingDirection: writing },
    ...
    sessionCard: { flexDirection: row, alignItems: 'stretch', gap: spacing.sm, marginTop: spacing.md, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, sessionTime: { width: 68, minHeight: 74, alignItems: 'center', justifyContent: 'center', borderRadius: radius.lg, backgroundColor: p.primaryMuted }, sessionTimeValue: { color: p.primary, fontSize: 17, fontWeight: '800', fontVariant: ['tabular-nums'] }, sessionTimeLabel: { marginTop: 2, color: p.muted, fontSize: 10, fontWeight: '500' }, sessionBody: { flex: 1 }, sessionTitleRow: { flexDirection: row, alignItems: 'center', justifyContent: 'space-between', gap: spacing.xs }, sessionTitle: { flex: 1, color: p.ink, fontSize: 17, fontWeight: '700', lineHeight: 24, textAlign: align }, statusPill: { paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: radius.md, backgroundColor: p.elevated }, statusActive: { backgroundColor: p.primaryMuted }, statusDone: { backgroundColor: p.primaryMuted }, statusText: { color: p.primary, fontSize: 10, fontWeight: '600' },
    ...
    profileCard: { flexDirection: row, alignItems: 'center', gap: spacing.md, padding: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, profileLarge: { width: 58, height: 58, borderRadius: 29, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', backgroundColor: p.primaryDeep, borderWidth: 3, borderColor: p.primaryMuted }, profileLargeText: { color: '#FFFFFF', fontSize: 24, fontWeight: '700' }, profileLargeImage: { width: '100%', height: '100%' }, profileCopy: { flex: 1 }, groupTitle: { marginTop: spacing.xl, marginBottom: spacing.sm, color: p.muted, fontSize: 12, fontWeight: '700', textAlign: align, textTransform: 'uppercase' }, menuRow: { minHeight: 66, flexDirection: row, alignItems: 'center', gap: spacing.sm }, rowInset: { flex: 1, alignSelf: 'stretch', flexDirection: row, alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: p.line }, menuTitle: { flex: 1, color: p.ink, fontSize: 16, fontWeight: '600', textAlign: align }, currentPlanCard: { minHeight: 94, flexDirection: row, alignItems: 'center', gap: spacing.sm, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised },
