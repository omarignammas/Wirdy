...
type MoreRoute = 'main' | 'sessions' | 'settings' | 'plan' | 'backup' | 'about' | LegalDocumentKey
...
function makeStyles(p: Palette, rtl: boolean) {
  ...
  return StyleSheet.create({
    ...
    legalSummary: { flexDirection: row, alignItems: 'flex-start', gap: 11, padding: 15, borderRadius: 18, backgroundColor: p.primaryMuted }, legalSummaryIcon: { width: 42, height: 42, flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: p.surface }, legalSummaryText: { flex: 1, color: p.ink, fontSize: 12, fontWeight: '700', lineHeight: 20, textAlign: align, writingDirection: writing }, legalSection: { paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: p.line }, legalSectionTitle: { color: p.ink, fontSize: 15, fontWeight: '900', lineHeight: 22, textAlign: align, writingDirection: writing }, legalSectionBody: { marginTop: 6, color: p.muted, fontSize: 11, fontWeight: '500', lineHeight: 20, textAlign: align, writingDirection: writing }, legalContact: { flexDirection: row, alignItems: 'flex-start', gap: 9, marginTop: 16, padding: 14, borderRadius: 16, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface }, legalContactText: { flex: 1, color: p.muted, fontSize: 10, lineHeight: 18, textAlign: align, writingDirection: writing },
