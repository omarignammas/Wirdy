...
function makeStyles(p: Palette, rtl: boolean) {
  ...
  return withAppFont(StyleSheet.create({
    ...
    nextStrip: { minHeight: 82, flexDirection: row, alignItems: 'center', justifyContent: 'space-between', padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.primaryMuted }, smallMuted: { color: p.muted, fontSize: 12, fontWeight: '700', textAlign: align, writingDirection: writing }, nextStripTitle: { marginTop: 2, color: p.primary, fontSize: 20, fontWeight: '900', textAlign: align }, timeChip: { minHeight: 46, flexDirection: row, alignItems: 'center', gap: spacing.xs, paddingHorizontal: spacing.md, borderRadius: radius.lg, backgroundColor: p.surface }, timeChipText: { color: p.primary, fontSize: 16, fontWeight: '900', fontVariant: ['tabular-nums'] },
    ...
    chartPanel: { minHeight: 236, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, chartSelected: { alignSelf: rtl ? 'flex-end' : 'flex-start', paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: radius.md, backgroundColor: p.primaryMuted }, chartSelectedText: { color: p.primary, fontSize: 11, fontWeight: '700' }, weekChart: { height: 188, flexDirection: row, alignItems: 'flex-end', justifyContent: 'space-between', gap: spacing.sm, marginTop: spacing.sm }, weekBarItem: { flex: 1, alignItems: 'center', gap: spacing.sm }, weekTrack: { width: 22, height: 152, overflow: 'hidden', justifyContent: 'flex-end', borderRadius: 11, backgroundColor: p.primaryMuted }, weekFill: { width: '100%', borderRadius: 11, backgroundColor: '#8AAE9F' }, weekLabel: { color: p.muted, fontSize: 11 }, weekLabelActive: { color: p.primary, fontWeight: '700' }, weekTotal: { color: p.muted, fontSize: 11, textAlign: 'center' },
    ...
    readerToolbar: { flexDirection: row, gap: spacing.sm, marginVertical: spacing.md }, toolbarButton: { flex: 1, minHeight: 52, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.xs, borderRadius: radius.lg, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...softRaised }, toolbarIconWrap: { position: 'relative' }, toolbarLabel: { color: p.ink, fontSize: 11, fontWeight: '700' }, toolbarCount: { position: 'absolute', top: -7, right: -8, minWidth: 14, height: 14, paddingHorizontal: 3, borderRadius: 7, alignItems: 'center', justifyContent: 'center', backgroundColor: p.gold }, toolbarCountText: { color: '#FFFFFF', fontSize: 8, fontWeight: '600' },
    mushafPage: { flex: 1, overflow: 'hidden', borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: dark === p ? p.elevated : '#FFFDF8', ...raised }, mushafPageExpanded: { borderRadius: 0, borderWidth: 0, shadowOpacity: 0, elevation: 0 }, mushafHeader: { minHeight: 52, flexDirection: row, alignItems: 'center', justifyContent: 'space-between', gap: spacing.sm, paddingHorizontal: spacing.md, borderBottomWidth: 1, borderBottomColor: p.line }, mushafHeaderEdge: { minWidth: 70, minHeight: 44, flexDirection: row, alignItems: 'center', justifyContent: rtl ? 'flex-start' : 'flex-end', gap: spacing.xs }, mushafMeta: { color: p.muted, fontSize: 10 }, mushafTitle: { flex: 1, color: p.primary, fontSize: 16, fontWeight: '700', textAlign: 'center' }, verses: { padding: spacing.md }, versesExpanded: { paddingHorizontal: spacing.lg, paddingTop: spacing.lg, paddingBottom: 84 }, verseRow: { position: 'relative', padding: spacing.sm, borderRadius: radius.sm }, verseSelected: { backgroundColor: p.primaryMuted }, quranText: { color: p.ink, lineHeight: 47, textAlign: 'right', writingDirection: 'rtl', fontFamily: Platform.OS === 'ios' ? 'Geeza Pro' : undefined }, verseMeta: { flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', gap: 4, marginTop: 3 }, verseNumber: { minWidth: 25, color: p.gold, fontSize: 10, fontWeight: '600' },
    ...
    summaryGrid: { flexDirection: row, flexWrap: 'wrap', overflow: 'hidden', marginBottom: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, summaryItem: { width: '50%', minHeight: 72, justifyContent: 'center', paddingHorizontal: spacing.md, borderBottomWidth: 1, borderRightWidth: 1, borderColor: p.line }, summaryValue: { color: p.ink, fontSize: 20, fontWeight: '800', fontVariant: ['tabular-nums'], textAlign: align }, summaryLabel: { color: p.muted, fontSize: 11, fontWeight: '500', textAlign: align },
    ...
    sessionCard: { flexDirection: row, alignItems: 'stretch', gap: spacing.sm, marginTop: spacing.md, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, sessionTime: { width: 68, minHeight: 74, alignItems: 'center', justifyContent: 'center', borderRadius: radius.lg, backgroundColor: p.primaryMuted }, sessionTimeValue: { color: p.primary, fontSize: 18, fontWeight: '900', fontVariant: ['tabular-nums'] }, sessionTimeLabel: { marginTop: 2, color: p.muted, fontSize: 10, fontWeight: '600' }, sessionBody: { flex: 1 }, sessionTitleRow: { flexDirection: row, alignItems: 'center', justifyContent: 'space-between', gap: spacing.xs }, sessionTitle: { flex: 1, color: p.ink, fontSize: 18, fontWeight: '800', lineHeight: 25, textAlign: align }, statusPill: { paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: radius.md, backgroundColor: p.elevated }, statusActive: { backgroundColor: p.primaryMuted }, statusDone: { backgroundColor: p.primaryMuted }, statusText: { color: p.primary, fontSize: 10, fontWeight: '700' },
    ...
    khatmaCard: { marginTop: spacing.md, padding: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, khatmaCardTop: { flexDirection: row, alignItems: 'flex-start', justifyContent: 'space-between', gap: spacing.sm }, khatmaCardCopy: { flex: 1 }, khatmaCardTitle: { color: p.ink, fontSize: 19, lineHeight: 27, fontWeight: '700', textAlign: align, writingDirection: writing }, daysChip: { flexDirection: row, alignItems: 'center', gap: 4, paddingHorizontal: spacing.sm, paddingVertical: spacing.sm, borderRadius: radius.md, backgroundColor: p.primaryMuted }, daysChipText: { color: p.primary, fontSize: 10, fontWeight: '600', fontVariant: ['tabular-nums'] }, khatmaProgressRow: { flexDirection: row, alignItems: 'center', gap: spacing.sm, marginTop: spacing.lg }, khatmaParts: { color: p.primary, fontSize: 11, fontWeight: '700', fontVariant: ['tabular-nums'] }, khatmaPercent: { color: p.muted, fontSize: 11, fontWeight: '600', fontVariant: ['tabular-nums'] }, khatmaTrack: { flex: 1, height: 8, overflow: 'hidden', borderRadius: 4, backgroundColor: p.primaryMuted }, khatmaFill: { height: '100%', borderRadius: 4, backgroundColor: p.primary }, khatmaEmpty: { alignItems: 'center', justifyContent: 'center', gap: 4, minHeight: 190, marginTop: spacing.md, padding: spacing.xl, borderRadius: radius.xl, borderWidth: 1, borderStyle: 'dashed', borderColor: p.line, backgroundColor: p.surface, ...softRaised },
    khatmaDetailHeader: { flexDirection: row, alignItems: 'center', gap: spacing.sm, marginBottom: spacing.md }, khatmaHero: { marginTop: spacing.md, padding: spacing.lg, borderRadius: radius.xxl, backgroundColor: p.primaryDeep, shadowColor: p.shadow, shadowOpacity: 1, shadowRadius: 24, shadowOffset: { width: 0, height: 12 }, elevation: 3 }, khatmaSchedule: { alignSelf: rtl ? 'flex-end' : 'flex-start', flexDirection: row, alignItems: 'center', gap: spacing.xs, marginTop: spacing.md, paddingHorizontal: spacing.sm, paddingVertical: spacing.sm, borderRadius: radius.md, backgroundColor: 'rgba(255,255,255,0.12)' }, khatmaScheduleText: { color: '#FFFFFF', fontSize: 11, fontWeight: '600' }, khatmaInvite: { minHeight: 44, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, marginTop: spacing.sm }, khatmaInviteText: { color: 'rgba(255,255,255,0.76)', fontSize: 11, fontWeight: '600', fontVariant: ['tabular-nums'] },
    khatmaSessionRow: { minHeight: 78, flexDirection: row, alignItems: 'center', gap: spacing.md, borderBottomWidth: 1, borderBottomColor: p.line }, khatmaSessionIcon: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: p.primaryMuted }, khatmaSessionCopy: { flex: 1 }, memberStack: { overflow: 'hidden', paddingHorizontal: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, memberRow: { minHeight: 70, flexDirection: row, alignItems: 'center', gap: spacing.sm, borderBottomWidth: 1, borderBottomColor: p.line }, memberAvatar: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 22, backgroundColor: p.primaryMuted }, memberAvatarText: { color: p.primary, fontSize: 15, fontWeight: '800' }, memberCopy: { flex: 1 },
