...
function CircularProgress({ value, size, strokeWidth, trackColor, progressColor, textColor, label, labelColor, language }: { value: number; size: number; strokeWidth: number; trackColor: string; progressColor: string; textColor: string; label: string; labelColor: string; language: Language }) {
  ...
  const valueFontSize = Math.max(24, Math.round(size * 0.24))
  const labelFontSize = size >= 100 ? 11 : 10
...
function makeStyles(p: Palette, rtl: boolean) {
  ...
  return withAppFont(StyleSheet.create({
    ...
    header: { position: 'relative', flexDirection: row, alignItems: 'center', gap: spacing.sm, paddingHorizontal: spacing.lg, paddingTop: Platform.OS === 'android' ? 15 : spacing.md, paddingBottom: spacing.md }, headerHairline: { position: 'absolute', left: 0, right: 0, bottom: 0, height: StyleSheet.hairlineWidth, backgroundColor: p.line }, largeTitle: { color: p.ink, fontSize: 38, lineHeight: 44, fontWeight: '900', marginBottom: spacing.md, textAlign: align, writingDirection: writing },
    ...
    headerCopy: { flex: 1, minWidth: 0, justifyContent: 'center' }, headerActions: { flexDirection: row, alignItems: 'center', gap: 4 }, headerKicker: { color: p.muted, fontSize: 11, fontWeight: '700', textAlign: align, writingDirection: writing }, headerTitle: { color: p.ink, fontSize: 23, fontWeight: '900', lineHeight: 31, textAlign: align, writingDirection: writing },
    ...
    notificationToast: { position: 'absolute', zIndex: 20, top: 104, left: spacing.lg, right: spacing.lg, minHeight: 58, flexDirection: row, alignItems: 'center', gap: 8, paddingHorizontal: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, shadowColor: p.shadow, shadowOpacity: 1, shadowRadius: 20, shadowOffset: { width: 0, height: 10 }, elevation: 3 }, notificationToastText: { flex: 1, color: p.ink, fontSize: 15, lineHeight: 20, fontWeight: '800', textAlign: align, writingDirection: writing },
    nextStrip: { minHeight: 82, flexDirection: row, alignItems: 'center', justifyContent: 'space-between', padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.primaryMuted }, smallMuted: { color: p.muted, fontSize: 12, fontWeight: '700', textAlign: align, writingDirection: writing }, nextStripTitle: { marginTop: 2, color: p.primary, fontSize: 20, fontWeight: '900', textAlign: align }, timeChip: { minHeight: 50, flexDirection: row, alignItems: 'center', gap: spacing.xs, paddingHorizontal: spacing.md, borderRadius: radius.lg, backgroundColor: p.surface }, timeChipText: { color: p.primary, fontSize: 19, lineHeight: 24, fontWeight: '900', fontVariant: ['tabular-nums'] },
    heroCard: { marginTop: spacing.md, padding: spacing.lg, borderRadius: radius.xxl, backgroundColor: p.primaryDeep, shadowColor: p.shadow, shadowOpacity: 1, shadowRadius: 24, shadowOffset: { width: 0, height: 12 }, elevation: 3 }, heroTop: { flexDirection: row, alignItems: 'flex-start', justifyContent: 'space-between', gap: spacing.sm }, heroKicker: { color: 'rgba(255,255,255,0.72)', fontSize: 12, fontWeight: '700', textAlign: align }, heroTitle: { maxWidth: 260, marginTop: 2, color: '#FFFFFF', fontSize: 29, fontWeight: '900', lineHeight: 36, textAlign: align, writingDirection: writing }, partChip: { paddingHorizontal: spacing.sm, paddingVertical: spacing.sm, borderRadius: radius.md, backgroundColor: 'rgba(255,255,255,0.11)' }, partChipText: { color: '#FFFFFF', fontSize: 11, fontWeight: '800' },
    heroProgress: { flexDirection: row, alignItems: 'center', justifyContent: 'space-between', marginTop: spacing.lg, paddingHorizontal: spacing.xs }, heroPosition: { flex: 1, marginStart: spacing.lg }, heroSurah: { color: '#FFFFFF', fontSize: 24, fontWeight: '900', lineHeight: 32, textAlign: align }, heroMeta: { color: 'rgba(255,255,255,0.72)', fontSize: 11, fontWeight: '600', textAlign: align }, heroMetaRow: { flexDirection: row, alignItems: 'center', gap: spacing.xs, marginTop: spacing.sm }, heroActions: { flexDirection: row, gap: spacing.sm, marginTop: spacing.lg }, heroPrimary: { flex: 1, minHeight: 47, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderRadius: radius.md, backgroundColor: '#FFFFFF' }, heroPrimaryText: { color: p.primaryDeep, fontSize: 14, fontWeight: '800' }, heroGhost: { width: 47, minHeight: 47, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, borderWidth: 1, borderColor: 'rgba(255,255,255,0.28)' },
    sectionHeader: { flexDirection: row, alignItems: 'center', justifyContent: 'space-between', marginTop: spacing.lg, marginBottom: spacing.sm }, sectionTitle: { flex: 1, color: p.ink, fontSize: 19, fontWeight: '900', lineHeight: 26, textAlign: align }, sectionAction: { color: p.primary, fontSize: 12, fontWeight: '800' },
    chartPanel: { minHeight: 236, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, chartSelected: { alignSelf: rtl ? 'flex-end' : 'flex-start', paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: radius.md, backgroundColor: p.primaryMuted }, chartSelectedText: { color: p.primary, fontSize: 13, fontWeight: '900', fontVariant: ['tabular-nums'] }, weekChart: { height: 188, flexDirection: row, alignItems: 'flex-end', justifyContent: 'space-between', gap: spacing.sm, marginTop: spacing.sm }, weekBarItem: { flex: 1, alignItems: 'center', gap: spacing.sm }, weekTrack: { width: 24, height: 152, overflow: 'hidden', justifyContent: 'flex-end', borderRadius: 12, backgroundColor: p.primaryMuted }, weekFill: { width: '100%', borderRadius: 12, backgroundColor: '#8AAE9F' }, weekLabel: { color: p.muted, fontSize: 12, fontWeight: '700' }, weekLabelActive: { color: p.primary, fontWeight: '900' }, weekTotal: { color: p.muted, fontSize: 13, fontWeight: '800', textAlign: 'center', fontVariant: ['tabular-nums'] },
    ...
    activityBody: { flexDirection: row, alignItems: 'flex-start', gap: spacing.md }, activityStatCol: { width: 124, gap: 3 }, activityValue: { color: p.ink, fontSize: 34, lineHeight: 38, fontWeight: '900', fontVariant: ['tabular-nums'], textAlign: align }, activityUnit: { color: p.muted, fontSize: 14, fontWeight: '800' }, activityValueLabel: { color: p.muted, fontSize: 10, fontWeight: '800', textAlign: align, textTransform: 'uppercase', marginBottom: spacing.sm }, activityChangeRow: { flexDirection: 'row', alignItems: 'center', gap: 3 }, activityChangeText: { fontSize: 15, fontWeight: '900', fontVariant: ['tabular-nums'] }, activityChangeLabel: { color: p.muted, fontSize: 10, fontWeight: '700', textAlign: align, textTransform: 'uppercase' },
    ...
    pageNavigation: { minHeight: 59, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, paddingTop: spacing.sm }, pageButton: { width: 45, height: 45, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface }, pageCenter: { minWidth: 118, minHeight: 49, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: p.primaryMuted }, pageCenterLabel: { color: p.muted, fontSize: 9, fontWeight: '700' }, pageCenterValue: { color: p.primary, fontSize: 16, lineHeight: 20, fontWeight: '900', fontVariant: ['tabular-nums'] },
    pageIntro: { flexDirection: row, alignItems: 'center', gap: spacing.sm, marginBottom: spacing.lg }, pageIntroIcon: { width: 44, height: 44, flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: p.primaryMuted }, pageIntroCopy: { flex: 1 }, pageIntroTitle: { color: p.ink, fontSize: 23, fontWeight: '800', lineHeight: 31, textAlign: align }, pageIntroText: { marginTop: 2, color: p.muted, fontSize: 12, fontWeight: '500', lineHeight: 18, textAlign: align, writingDirection: writing },
    summaryGrid: { flexDirection: row, flexWrap: 'wrap', overflow: 'hidden', marginBottom: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, summaryItem: { width: '50%', minHeight: 86, justifyContent: 'center', paddingHorizontal: spacing.md, borderBottomWidth: 1, borderRightWidth: 1, borderColor: p.line }, summaryValue: { color: p.ink, fontSize: 28, lineHeight: 32, fontWeight: '900', fontVariant: ['tabular-nums'], textAlign: align }, summaryLabel: { color: p.muted, fontSize: 11, fontWeight: '700', textAlign: align },
    ...
    sessionCard: { flexDirection: row, alignItems: 'stretch', gap: spacing.sm, marginTop: spacing.md, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, sessionTime: { width: 78, minHeight: 82, alignItems: 'center', justifyContent: 'center', borderRadius: radius.lg, backgroundColor: p.primaryMuted }, sessionTimeValue: { color: p.primary, fontSize: 22, lineHeight: 27, fontWeight: '900', fontVariant: ['tabular-nums'] }, sessionTimeLabel: { marginTop: 2, color: p.muted, fontSize: 10, fontWeight: '700' }, sessionBody: { flex: 1 }, sessionTitleRow: { flexDirection: row, alignItems: 'center', justifyContent: 'space-between', gap: spacing.xs }, sessionTitle: { flex: 1, color: p.ink, fontSize: 18, fontWeight: '800', lineHeight: 25, textAlign: align }, statusPill: { paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: radius.md, backgroundColor: p.elevated }, statusActive: { backgroundColor: p.primaryMuted }, statusDone: { backgroundColor: p.primaryMuted }, statusText: { color: p.primary, fontSize: 10, fontWeight: '700' },
    khatmaListHeader: { minHeight: 78, flexDirection: row, alignItems: 'center', gap: spacing.md, marginBottom: spacing.md }, khatmaListKicker: { color: p.muted, fontSize: 12, fontWeight: '600', textAlign: align }, khatmaListTitle: { marginTop: 2, color: p.ink, fontSize: 32, lineHeight: 40, fontWeight: '800', textAlign: align }, khatmaAdd: { width: 54, height: 54, flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: 27, backgroundColor: p.primaryDeep, shadowColor: p.shadow, shadowOpacity: 1, shadowRadius: 13, shadowOffset: { width: 0, height: 7 }, elevation: 2 },
    circlesSection: { marginBottom: spacing.lg }, circlesTitle: { color: p.ink, fontSize: 17, fontWeight: '700', marginBottom: spacing.sm, textAlign: align }, circlesScroll: { flexDirection: row, gap: spacing.md, paddingBottom: 6 }, circleCard: { width: 156, height: 134, borderRadius: radius.xl, overflow: 'hidden', padding: spacing.md, justifyContent: 'flex-end', backgroundColor: p.primaryDeep, ...raised }, circleWatermark: { position: 'absolute', top: -10, insetInlineEnd: -10, opacity: 0.14 }, circleName: { color: '#FFFFFF', fontSize: 16, fontWeight: '800', textAlign: align }, circleMeta: { marginTop: 2, color: 'rgba(255,255,255,0.7)', fontSize: 11, fontWeight: '600', textAlign: align }, circleTime: { marginTop: 6, color: '#FFFFFF', fontSize: 12, fontWeight: '700', textAlign: align }, circleAddCard: { width: 156, height: 134, borderRadius: radius.xl, borderWidth: 1, borderStyle: 'dashed', borderColor: p.line, alignItems: 'center', justifyContent: 'center', gap: spacing.xs, backgroundColor: p.surface, ...softRaised }, circleAddText: { color: p.muted, fontSize: 12, fontWeight: '700', textAlign: 'center' },
    ...
    khatmaCard: { marginTop: spacing.md, padding: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, khatmaCardTop: { flexDirection: row, alignItems: 'flex-start', justifyContent: 'space-between', gap: spacing.sm }, khatmaCardCopy: { flex: 1 }, khatmaCardTitle: { color: p.ink, fontSize: 19, lineHeight: 27, fontWeight: '700', textAlign: align, writingDirection: writing }, daysChip: { flexDirection: row, alignItems: 'center', gap: 4, paddingHorizontal: spacing.sm, paddingVertical: spacing.sm, borderRadius: radius.md, backgroundColor: p.primaryMuted }, daysChipText: { color: p.primary, fontSize: 12, lineHeight: 16, fontWeight: '900', fontVariant: ['tabular-nums'] }, khatmaProgressRow: { flexDirection: row, alignItems: 'center', gap: spacing.sm, marginTop: spacing.lg }, khatmaParts: { color: p.primary, fontSize: 14, fontWeight: '900', fontVariant: ['tabular-nums'] }, khatmaPercent: { color: p.muted, fontSize: 14, fontWeight: '900', fontVariant: ['tabular-nums'] }, khatmaTrack: { flex: 1, height: 9, overflow: 'hidden', borderRadius: 4.5, backgroundColor: p.primaryMuted }, khatmaFill: { height: '100%', borderRadius: 4.5, backgroundColor: p.primary }, khatmaEmpty: { alignItems: 'center', justifyContent: 'center', gap: 4, minHeight: 190, marginTop: spacing.md, padding: spacing.xl, borderRadius: radius.xl, borderWidth: 1, borderStyle: 'dashed', borderColor: p.line, backgroundColor: p.surface, ...softRaised },
    ...
    profileCard: { flexDirection: row, alignItems: 'center', gap: spacing.md, padding: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, profileLarge: { width: 58, height: 58, borderRadius: 29, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', backgroundColor: p.primaryDeep, borderWidth: 3, borderColor: p.primaryMuted }, profileLargeText: { color: '#FFFFFF', fontSize: 25, fontWeight: '800' }, profileLargeImage: { width: '100%', height: '100%' }, profileCopy: { flex: 1 }, groupTitle: { marginTop: spacing.xl, marginBottom: spacing.sm, color: p.muted, fontSize: 12, fontWeight: '800', textAlign: align, textTransform: 'uppercase' }, menuRow: { minHeight: 66, flexDirection: row, alignItems: 'center', gap: spacing.sm }, rowInset: { flex: 1, alignSelf: 'stretch', flexDirection: row, alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: p.line }, menuTitle: { flex: 1, color: p.ink, fontSize: 17, fontWeight: '800', textAlign: align }, currentPlanCard: { minHeight: 94, flexDirection: row, alignItems: 'center', gap: spacing.sm, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised },
    subpageHeader: { flexDirection: row, alignItems: 'center', gap: spacing.sm, marginBottom: spacing.md }, subpageCopy: { flex: 1 }, settingRow: { minHeight: 70, flexDirection: row, alignItems: 'center', gap: spacing.sm }, settingTitle: { flex: 1, color: p.ink, fontSize: 15, fontWeight: '800', textAlign: align }, stepper: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, stepButton: { width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: p.primaryMuted }, stepValue: { minWidth: 54, color: p.ink, fontSize: 17, lineHeight: 22, fontWeight: '900', textAlign: 'center', fontVariant: ['tabular-nums'] }, settingChoice: { paddingVertical: spacing.md, borderBottomWidth: 1, borderBottomColor: p.line }, settingChoiceTitle: { marginBottom: spacing.sm, color: p.ink, fontSize: 14, fontWeight: '800', textAlign: align }, dangerButton: { minHeight: 50, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, marginTop: spacing.lg, borderRadius: radius.md, backgroundColor: `${p.danger}12` }, dangerText: { color: p.danger, fontSize: 12, fontWeight: '800' },
    ...
    positionCard: { flexDirection: row, alignItems: 'center', gap: spacing.sm, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, positionCopy: { flex: 1 }, planCard: { marginBottom: spacing.md, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, planCardDisabled: { opacity: 0.62 }, planTop: { flexDirection: row, alignItems: 'center', gap: spacing.sm }, planNumber: { width: 50, height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: p.primary }, planNumberText: { color: '#FFFFFF', fontSize: 20, lineHeight: 25, fontWeight: '900', fontVariant: ['tabular-nums'] }, planCopy: { flex: 1 }, planDetails: { flexDirection: row, flexWrap: 'wrap', gap: spacing.sm, marginTop: spacing.sm }, planDetail: { paddingHorizontal: spacing.sm, paddingVertical: spacing.xs, borderRadius: radius.md, backgroundColor: p.elevated, color: p.muted, fontSize: 12, fontWeight: '800', fontVariant: ['tabular-nums'] }, addButton: { minHeight: 52, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, borderRadius: radius.lg, borderWidth: 1, borderStyle: 'dashed', borderColor: p.primary, backgroundColor: p.primaryMuted }, addButtonText: { color: p.primary, fontSize: 13, fontWeight: '700' }, saveBar: { minHeight: 56, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, marginTop: spacing.md, borderRadius: radius.lg, backgroundColor: p.primary, ...softRaised }, saveBarText: { color: '#FFFFFF', fontSize: 15, fontWeight: '800' },
    privacyBanner: { flexDirection: row, alignItems: 'flex-start', gap: spacing.sm, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.primaryMuted }, privacyCopy: { flex: 1 }, backupCard: { marginTop: spacing.md, padding: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, backupIcon: { width: 47, height: 47, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: p.primaryMuted }, backupTitle: { marginTop: spacing.md, color: p.ink, fontSize: 19, fontWeight: '700', textAlign: align }, backupText: { marginTop: 5, color: p.muted, fontSize: 12, lineHeight: 19, textAlign: align, writingDirection: writing }, successBanner: { minHeight: 50, flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.sm, marginTop: spacing.md, borderRadius: radius.lg, backgroundColor: p.primaryMuted }, successText: { color: p.success, fontSize: 12, fontWeight: '600' },
    ...
    aboutHero: { alignItems: 'center', padding: spacing.lg, borderRadius: radius.xl, backgroundColor: p.primaryDeep, ...raised }, aboutMark: { width: 64, height: 64, alignItems: 'center', justifyContent: 'center', borderRadius: radius.xl, backgroundColor: '#FFFFFF' }, aboutMarkText: { color: p.primaryDeep, fontSize: 31, fontWeight: '800' }, aboutTitle: { marginTop: spacing.md, color: '#FFFFFF', fontSize: 22, fontWeight: '800', textAlign: 'center' }, aboutText: { marginTop: spacing.sm, color: 'rgba(255,255,255,0.67)', fontSize: 12, lineHeight: 19, textAlign: 'center' },
    legalSummary: { flexDirection: row, alignItems: 'flex-start', gap: spacing.sm, padding: spacing.lg, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.primaryMuted }, legalSummaryIcon: { width: 42, height: 42, flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: p.surface }, legalSummaryText: { flex: 1, color: p.ink, fontSize: 13, fontWeight: '600', lineHeight: 21, textAlign: align, writingDirection: writing }, legalSection: { paddingVertical: spacing.lg, borderBottomWidth: 1, borderBottomColor: p.line }, legalSectionTitle: { color: p.ink, fontSize: 17, fontWeight: '700', lineHeight: 24, textAlign: align, writingDirection: writing }, legalSectionBody: { marginTop: spacing.sm, color: p.muted, fontSize: 12, fontWeight: '500', lineHeight: 21, textAlign: align, writingDirection: writing }, legalContact: { flexDirection: row, alignItems: 'flex-start', gap: spacing.sm, marginTop: spacing.lg, padding: spacing.md, borderRadius: radius.xl, borderWidth: 1, borderColor: p.line, backgroundColor: p.surface, ...raised }, legalContactText: { flex: 1, color: p.muted, fontSize: 11, lineHeight: 19, textAlign: align, writingDirection: writing },
    tabBarShadow: { position: 'absolute', left: 7, right: 7, bottom: 9, minHeight: 84, borderRadius: 34, shadowColor: p.shadow, shadowOpacity: 1, shadowRadius: 28, shadowOffset: { width: 0, height: 12 }, elevation: 4 }, tabBar: { flex: 1, flexDirection: row, alignItems: 'center', gap: 2, paddingHorizontal: 7, paddingVertical: 8, borderRadius: 34, borderWidth: 1, borderColor: p.line, overflow: 'hidden' }, tabTint: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: p.tab }, tabItem: { flex: 1, minHeight: 66, alignItems: 'center', justifyContent: 'center' }, tabPillBase: { flexDirection: row, alignItems: 'center', justifyContent: 'center', gap: spacing.xs, minHeight: 52, minWidth: 52, paddingHorizontal: spacing.sm, borderRadius: 26 }, tabPillActive: { paddingHorizontal: spacing.md, backgroundColor: p.primaryMuted, shadowColor: p.shadow, shadowOpacity: 0.78, shadowRadius: 10, shadowOffset: { width: 0, height: 5 }, elevation: 1 }, tabLabel: { color: p.primary, fontSize: 13, fontWeight: '800' },
